...
describe HackersController do
  ...
  # Hacker. As you add validations to Hacker, be sure to
  ...
  describe "GET index" do
    it "assigns all hackers as @hackers" do
      ...
      assigns(:hackers).should eq([hacker])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested hacker as @hacker" do
      ...
      assigns(:hacker).should eq(hacker)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new hacker as @hacker" do
      ...
      assigns(:hacker).should be_a_new(Hacker)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created hacker as @hacker" do
        post :create, {:hacker => valid_attributes}, valid_session
        assigns(:hacker).should be_a(Hacker)
        assigns(:hacker).should be_persisted
      end

      it "redirects to the created hacker" do
        post :create, {:hacker => valid_attributes}, valid_session
        response.should redirect_to(Hacker.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hacker as @hacker" do
        ...
        Hacker.any_instance.stub(:save).and_return(false)
        post :create, {:hacker => {}}, valid_session
        assigns(:hacker).should be_a_new(Hacker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hacker" do
        hacker = Hacker.create! valid_attributes
        # Assuming there are no other hackers in the database, this
        # specifies that the Hacker created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Hacker.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => hacker.to_param, :hacker => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the hacker" do
        hacker = Hacker.create! valid_attributes
        put :update, {:id => hacker.to_param, :hacker => valid_attributes}, valid_session
        response.should redirect_to(hacker)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the hacker as @hacker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hacker.any_instance.stub(:save).and_return(false)
        put :update, {:id => hacker.to_param, :hacker => {}}, valid_session
        assigns(:hacker).should eq(hacker)
      end
